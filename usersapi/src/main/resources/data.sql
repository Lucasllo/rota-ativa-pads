...
INSERT INTO "administrador" ("id_administrador","nome","cpf","email","data_nasc","senha")
VALUES
...
INSERT INTO "usuario" ("id_usuario","cpf","nome","acessibilidade","email","senha","data_nasc","ticket")
VALUES
...
INSERT INTO "vaga" ("id_vaga","rua_avenida","bairro","acessibilidade","nome_vaga","longitude_inicial","longitude_final","latitude_inicial","latitude_final","horario_uso_inicial","horario_uso_final","estado_vaga","tempo_ticket")
VALUES
...
INSERT INTO "pagamento" ("id_pagamento","data_compra","valor","quantidade_ticket","usuario_idusuario")
VALUES
  (1,'2022-01-16',7,1,1),
  (2,'2022-05-1',86,8,2),
  ...
  INSERT INTO "tipopagamento" ("id_tipo_pagamento","tipo_pagamento","desc_pagamento","pagamento_id_pagamento")
VALUES
  (1,'credito','sem molestie sodales.',1),
  (2,'debito','pretium neque. ',1),
  (3,'debito','commodo auctor velit.',1),
  (4,'credito','Integer tincidunt ',1),
  (5,'credito','per conubia nostral',1);
...
INSERT INTO "telefone" ("id_telefone","usuario_id_usuario","telefone")
VALUES
  (1,1,'(95)3489-4683'),
  (2,2,'(92)2444-7743'),
  (3,3,'(84)3515-4566'),
...
INSERT INTO "transacao" ("id_transacao","vaga_id_vaga","usuario_id_usuario","tickets_usados","entrada","saida")
VALUES
...
INSERT INTO "usuario_has_veiculo" ("usuario_id_usuario","veiculo_id_veiculo")
VALUES
